...
"""
CREATING new donations from existing donors in the database, rhis function includes
handler function should accept both GET requests and POST requests
"""
